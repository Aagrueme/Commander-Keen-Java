...
public class MenuLevel extends Level implements Serializable {
    ...
    public MenuLevel() {
        ...
        setBlocks(convertFileToLevelData("commanderKeen/levels/menu_level.txt", new LevelBlockShortcut[]{
                ...
                new LevelBlockShortcut("trap", Blocks.ShowBlocks.BLOCK_TRAP_SHOW),
                new LevelBlockShortcut("st", Blocks.ShowBlocks.BLOCK_SIGN_SHOW_TOP),
                new LevelBlockShortcut("sb", Blocks.ShowBlocks.BLOCK_SIGN_SHOW_BOTTOM),
